...
const SingleBlog = () => {
    ...
    const {url} = useParams();
    const blog = BlogData.find(academic => academic.url === url);
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-9">
                                ...
                                <img className='single-blog-banner' src={img} alt="academic banner"/>
                                <p className="single-blog-text"> information about </p>
